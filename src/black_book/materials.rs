...
pub fn load_material_database() -> std::collections::HashMap<String, MaterialData> {
    ...
    db.insert(
        "Steel 8620".to_string(),
        MaterialData {
            name: "Steel 8620".to_string(),
            category: MaterialCategory::SteelLowAlloy,
            grades: vec!["8620".to_string(), "8620H".to_string()],
            description:
                "Case-hardening steel, tough core with hard surface. Mil-spec for firearm parts."
                    .to_string(),
    ...
    db.insert(
        ...
        MaterialData {
            ...
            chip_loads_hss: vec![
                0.00005, 0.0001, 0.0002, 0.0003, 0.0005, 0.001, 0.0015, 0.002,
            ],
            max_doc_diameter_ratio: 0.3,
    ...
    db.insert(
        ...
        MaterialData {
            ...
            chip_loads_hss: vec![
                0.00005, 0.0001, 0.0002, 0.0003, 0.0005, 0.0008, 0.001, 0.0015,
            ],
